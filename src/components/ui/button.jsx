// Button.jsx - Componente botón con variantes y tamaños usando cva + Tailwind

import * as React from "react";
import { Slot } from "@radix-ui/react-slot";
import { cva } from "class-variance-authority";
import { cn } from "@/lib/utils"; // Combina clases condicionales

// Variantes del botón (color, tamaño, etc.)
...
function Button({ className, variant, size, asChild = false, ...props }) {
  const Comp = asChild ? Slot : "button"; // Usa Slot de Radix si asChild es true
